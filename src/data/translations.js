export const TRANSLATIONS = {
  en: {
    ...
    badgeExpand: 'Show my badge',
    badgeCollapse: 'Hide my badge',
    ...
    icebreakerLabel: 'Conversation starter',
    icebreakerPh: 'Ask me about my newest project! (optional)',

    tabDiscover: 'Discover',
    discoverIntro: 'People with something in common with you, one at a time. Tap Connect to say you’d like to meet, or Pass to see the next person.',
    discoverPass: 'Pass',
    discoverLike: 'Connect',
    discoverEmpty: 'That’s everyone for now. Check back after more attendees join.',
    discoverSharedInterests: 'You both share',
    discoverMatchBanner: 'It’s a match! Say hello.',
    discoverKeepBrowsing: 'Keep browsing',
    discoverMyMatches: 'My matches',
    discoverMatchesEmpty: 'No matches yet. Keep going!',
    discoverMessage: 'Message',

    tabPhotos: 'Photos',
    photoContestTitle: 'Photo wall',
    photoContestIntro: 'Post a photo for today’s themes and cheer on your favorites.',
    photoThemeAll: 'All',
    photoThemeSquad: 'Conference squad',
    photoThemeMoment: 'Favorite moment',
    photoThemeSelfcare: 'Self-care corner',
    photoPostButton: 'Post a photo',
    photoChooseTheme: 'Choose a theme',
    photoCaptionPh: 'Add a caption (optional)',
    photoUploadButton: 'Post',
    photoUploading: 'Posting…',
    photoEmpty: 'No photos yet for this theme. Be the first!',
    photoVoteLabel: 'Cheer for this photo',
  ...
  es: {
    ...
    badgeExpand: 'Mostrar mi credencial',
    badgeCollapse: 'Ocultar mi credencial',
    ...
    icebreakerLabel: 'Tema para romper el hielo',
    icebreakerPh: 'Pregúntame sobre mi proyecto más reciente (opcional)',

    tabDiscover: 'Descubrir',
    discoverIntro: 'Personas que tienen algo en común contigo, una a la vez. Toca Conectar para decir que te gustaría conocerla, o Pasar para ver a la siguiente persona.',
    discoverPass: 'Pasar',
    discoverLike: 'Conectar',
    discoverEmpty: 'Eso es todo por ahora. Vuelve más tarde cuando se unan más asistentes.',
    discoverSharedInterests: 'Ambas comparten',
    discoverMatchBanner: '¡Es una conexión! Salúdala.',
    discoverKeepBrowsing: 'Seguir explorando',
    discoverMyMatches: 'Mis conexiones',
    discoverMatchesEmpty: 'Aún no tienes conexiones. ¡Sigue intentando!',
    discoverMessage: 'Mensaje',

    tabPhotos: 'Fotos',
    photoContestTitle: 'Muro de fotos',
    photoContestIntro: 'Publica una foto para los temas de hoy y anima a tus favoritas.',
    photoThemeAll: 'Todas',
    photoThemeSquad: 'Escuadrón de la conferencia',
    photoThemeMoment: 'Momento favorito',
    photoThemeSelfcare: 'Rincón de autocuidado',
    photoPostButton: 'Publicar una foto',
    photoChooseTheme: 'Elige un tema',
    photoCaptionPh: 'Agrega un pie de foto (opcional)',
    photoUploadButton: 'Publicar',
    photoUploading: 'Publicando…',
    photoEmpty: 'Aún no hay fotos para este tema. ¡Sé la primera!',
    photoVoteLabel: 'Anima esta foto',
