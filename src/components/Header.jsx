...
export default function Header({ name, avatarUrl, hideAvatar, live, liveLabel, offlineLabel, langToggle, onToggleLang, onAvatarClick }) {
  return (
    <div className="app-header">
      ...
      <div className="header-overlay">
        {!hideAvatar && <Avatar url={avatarUrl} name={name} size={38} fontSize={14} rounded={false} onClick={onAvatarClick} />}
        <div style={{ flex: 1 }} />
